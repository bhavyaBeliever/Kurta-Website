    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('xl', models.IntegerField(default=1)),
                ('Occasion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Fest', to='users.festival')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kurta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='kurta', to='users.kurta')),
            ],
        ),
    ]
